...
-- =====================================================
ALTER TABLE eg_user
    ADD COLUMN idpissuer    character varying(512),
    ADD COLUMN idpsubject   character varying(512),
    ADD COLUMN authprovider character varying(64) DEFAULT 'LOCAL';
...
ALTER TABLE eg_user_audit_table
    ADD COLUMN idpissuer    character varying(512),
    ADD COLUMN idpsubject   character varying(512),
    ADD COLUMN authprovider character varying(64);
...
CREATE INDEX idx_eg_user_idp_tenantid_uuid_id
...
CREATE INDEX idx_eg_user_idp_details_audit_tenantid_uuid_userid
